...
export const LOCALE_MAP: Record<string, LocaleEntry> = {
  ...
  "/colombia/mejores-casinos-online/": { lang: "es-CO", hreflangCluster: "country-listicles" },
  ...
  "/venezuela/mejores-casinos-online/": { lang: "es-VE", hreflangCluster: "country-listicles" },
};
